          ...
          <div class="content-wrapper">
            ...
            <div class="line">
              <div>
                ...
                <span>{{ hospitalBookingRule.cycle }}天</span>
              </div>
              <div class="space">
                <span class="label">放号时间：</span>
                <span>{{ hospitalBookingRule.releaseTime }}</span>
              </div>
              <div class="space">
                <span class="label">停挂时间：</span>
                <span>{{ hospitalBookingRule.stopTime }}</span>
              </div>
            </div>
            <div class="line">
              <span class="label">退号时间：</span>
              <span v-if="hospitalBookingRule.quitDay == -1">
                就诊前一工作日{{ hospitalBookingRule.quitTime }}前取消
              </span>
...
function gotoSchedule(department) {
  router.push({
    path: `/hospital/${hospitalCode}/schedule`,
    query: {
